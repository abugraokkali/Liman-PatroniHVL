...
<ul class="nav nav-tabs" role="tablist" style="margin-bottom: 15px;">
    ...
    <li class="nav-item">
        <a class="nav-link active"  onclick="isYmlExists()" href="#init" data-toggle="tab">
        <i class="fas fa-cogs mr-2"></i>
        Initialization</a>

    </li>
    <li class="nav-item" >
        <a class="nav-link" onclick="hbaTable()" href="#addCluster" data-toggle="tab">
...
<div class="tab-content">
    ...
    <div id="init" class="tab-pane active">
        @include('pages.init')    
    </div>
